...
export class WorkExperiencePageComponent implements OnInit {
  ...
  workExperiences: WorkExperienceInfo[] = [
    ...
    details: {
      ...
      learningGoals: ['Grow my network and improve my networking skills', 'Get to know everyone on my team', 'Learn more about Cyber Security', 'Perform a team presentation about a topic or a new idea'],
